...
# Assuming you are using SQLite for local testing
...
def main():
    ...
    try:
        # Create PersonalInfo
        personal_info_data = schemas.PersonalInfoCreate(name="John Doe", tag="example_tag", tag_description="Example Description")
        ...
        retrieved_personal_info = crud.get_personal_info(db, personal_info.id)
        print(f"Retrieved PersonalInfo: {retrieved_personal_info}")
